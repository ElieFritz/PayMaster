...
async function getInvoice(invoiceId: string): Promise<Invoice | null> {
  const response = await fetch(`${getBackendUrl()}/invoices/${invoiceId}`, {
    cache: 'no-store',
  });
  ...
  return (
    <main className="relative isolate overflow-hidden py-10 sm:py-14">
      ...
      <section className="container">
        <article className="mx-auto max-w-5xl animate-shimmerIn overflow-hidden rounded-[30px] border border-[#96befb]/60 bg-white shadow-[0_40px_90px_rgba(5,18,47,0.5)]">
            ...
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:min-w-[300px] lg:grid-cols-1">
                ...
                <div className="rounded-2xl border border-white/35 bg-white/15 p-3 backdrop-blur">
                  ...
                  <p className="mt-1 text-xs text-blue-50/90">Ref: {invoice.reference}</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-4 border-b border-[#d7e7ff] bg-[#f5f9ff] px-6 py-5 sm:px-8 lg:grid-cols-3">
            <div className="rounded-2xl border border-[#d0e4ff] bg-white/95 p-4">
              ...
              <p className="mt-2 text-sm font-semibold text-[#0f327a]">{invoice.customerName}</p>
            ...
            <div className="rounded-2xl border border-[#d0e4ff] bg-white/95 p-4">
              ...
              <p className="mt-2 text-sm font-semibold text-[#0f327a]">{projectName || 'Prestation digitale'}</p>
          ...
          <div className="px-6 py-6 sm:px-8 sm:py-7">
            <div className="flex flex-wrap items-end justify-between gap-4">
              ...
              <p className="rounded-full border border-[#d0e2ff] bg-[#f3f8ff] px-4 py-2 text-sm font-semibold text-[#174392]">
                    ...
                    {services.map((line, idx) => {
                      ...
                      return (
                        <tr key={`${line.name}-${idx}`} className={rowColor}>
                          ...
                          <td className="px-4 py-3 text-[#24426f]">{line.name}</td>
